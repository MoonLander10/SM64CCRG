...
std::cout << "8107EC42 "; hex(); null end //цвет кепки
std::cout << "8107EC38 "; hex(); hexfix hex(); end //тень кепки
std::cout << "8107EC3A "; hex(); null end //тень кепки
if (vibor == '0') {
std::cout << "8107EC88 "; hex(); hexfix hex(); end //цвет еблета
std::cout << "8107EC8A "; hex(); null end //цвет еблета
std::cout << "8107EC80 "; hex(); hexfix hex(); end //тень еблета
std::cout << "8107EC82 "; hex(); null end //тень еблета
}
if (vibor == '1') {
...
std::cout << "8107EC5A "; hex(); null end //цвет перчаток
std::cout << "8107EC50 "; hex(); hexfix hex(); end //тень перчаток
std::cout << "8107EC52 "; hex(); null end //тень перчаток
std::cout << "8107EC28 "; hex(); hexfix hex(); end //цвет подштанников хуй знает что это
std::cout << "8107EC2A "; hex(); null end //цвет подштанников хуй знает что это
std::cout << "8107EC20 "; hex(); hexfix hex(); end //тень подштанников хуй знает что это
std::cout << "8107EC22 "; hex(); null end //тень подштанников хуй знает что это
std::cout << "8107ECA0 "; hex(); hexfix hex(); end //цвет волос
std::cout << "8107ECA2 "; hex(); null end //цвет волос
std::cout << "8107EC98 "; hex(); hexfix hex(); end //тень волос
std::cout << "8107EC9A "; hex(); null end //тень волос
std::cout << "8107EC70 "; hex(); hexfix hex(); end //цвет ботинков
std::cout << "8107EC72 "; hex(); null end //цвет ботинков
std::cout << "8107EC68 "; hex(); hexfix hex(); end //тень ботинков
std::cout << "8107EC6A "; hex(); null end //тень ботинков
}
else
{
